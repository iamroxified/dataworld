   ...
   <div class="main-header">
     <div class="main-header-logo">
       ...
       <div class="logo-header" data-background-color="dark">
         <a href="index" class="logo">
           <img src="assets/img/spg-logo.jpg" alt="navbar brand" class="navbar-brand" height="20" />
         </a>
     ...
     <nav class="navbar navbar-header navbar-header-transparent navbar-expand-lg border-bottom">
       <div class="container-fluid">
         <!-- <ul class="navbar-nav topbar-nav ms-md-auto align-items-center  d-lg-flex p-0  ">
        
           <li class=" nav-item px-5">
             <a class="btn btn-primary active" href="../index">
         ...
         <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
           ...
           <li class="nav-item topbar-icon dropdown hidden-caret">
             <a class="nav-link dropdown-toggle" href="#" id="notifDropdown" role="button" data-bs-toggle=""
           ...
           <li class="nav-item topbar-icon dropdown hidden-caret">
             <a class="nav-link" data-bs-toggle="" href="#" aria-expanded="false">
