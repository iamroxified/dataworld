...
$count_query = QueryDB("SELECT COUNT(*) as total FROM orders WHERE user_id = ?", [$bmid]);
$total_orders = $count_query->fetch(PDO::FETCH_ASSOC)['total'];
$total_pages = ceil($total_orders / $records_per_page);

// Get orders for current page
$orders_query = QueryDB("SELECT * FROM orders WHERE user_id = ? ORDER BY created_at DESC", 
                      [$bmid]);
        ...
        <div class="page-inner">
          <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
            <div>
              ...
              <h6 class="op-7 mb-2"><?php echo _greetin().', '.username($_SESSION['username']); ?>! Here are your recent orders</h6>
            </div>
          </div>
