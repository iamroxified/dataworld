            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body text-center">
                  <p>You are about to pay <strong><?php echo htmlspecialchars($order['total_amount']); ?></strong> for
                    your analytics request.</p>
      ...
      <script>
        function payWithPaystack() {
          var handler = PaystackPop.setup({
            key: 'pk_live_365a2af61353ffcb0a7ac3dfaebd8db75d6e4b30', // Replace with your public key
