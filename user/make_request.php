...
$program_pricing = [];
if ($pdo) {
    $pricing_query = "SELECT item_name, price FROM prices WHERE service_name = 'analytics'";
    $result = $pdo->query($pricing_query);
    $program_pricing = $result->fetchAll(PDO::FETCH_KEY_PAIR);
}
                        ...
                        <div class="col-md-4 mb-3">
                          ...
                          <select class="form-select" id="department" name="department" required>
                            ...
                            <option value="<?php echo htmlspecialchars($department); ?>">
                              <?php echo htmlspecialchars($department); ?></option>
                            <?php endforeach; ?>
                          </select>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-4 mb-3">
                          ...
                          <select class="form-select" id="program_type" name="program_type" required
                            ...
                            <?php foreach ($program_pricing as $program => $price): ?>
      ...
      <script>
        ...
        function updateCurrency() {
          ...
          if (selectedProgram.value) {
            let price = selectedProgram.getAttribute('data-price');
